 ...
 <meta name="description" content="Motherless Baby home login page">
 <!-- Title Page-->
 <title><?= $title; ?></title>
 ...
 <style>
    body {
       ...
       font-size: 16px;
       line-height: 1.625;
       background-image: url("<?= base_url('assets/dashboard/images/bg.jpg') ?>");
    ...
    .login-content {
       -webkit-box-shadow: 10px 6px 22px 3px rgba(0, 0, 0, 0.75);
       -moz-box-shadow: 10px 6px 22px 3px rgba(0, 0, 0, 0.75);
       box-shadow: 10px 6px 22px 3px rgba(0, 0, 0, 0.75);
    }
 </style>
...
<body>
   ...
   <?php $this->load->view('landing/fragments/header-main-fragment');?>
    ...
    <div class="fancy-breadcumb-area bg-img bg-overlay" style="background-image: url(<?=base_url('assets/img/bg-img/hero-1.jpg');?>);">
                        ...
                        <div class="col-10 col-sm-11">
                            <div class="single-post">
                                ...
                                <div class="post-thumb">
                                    <img src="<?=base_url('assets/img/blog-img/blog-4.jpg');?>" alt="">
                                </div>
                                <!-- Post Content -->
